...
public abstract class Hilt_VoucherFragmentHorizon<VBinding extends ViewBinding> extends VouchersListBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VoucherFragmentHorizon_GeneratedInjector) this.generatedComponent()).injectVoucherFragmentHorizon(UnsafeCasts.<VoucherFragmentHorizon>unsafeCast(this));
    }
  }
