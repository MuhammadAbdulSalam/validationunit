...
public abstract class Hilt_PlateRegistrationGaFragment<VBinding extends ViewBinding> extends EnterPlateBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlateRegistrationGaFragment_GeneratedInjector) this.generatedComponent()).injectPlateRegistrationGaFragment(UnsafeCasts.<PlateRegistrationGaFragment>unsafeCast(this));
    }
  }
