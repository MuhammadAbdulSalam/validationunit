...
public abstract class Hilt_PlateRegistrationC2cFragment<VBinding extends ViewBinding> extends EnterPlateBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlateRegistrationC2cFragment_GeneratedInjector) this.generatedComponent()).injectPlateRegistrationC2cFragment(UnsafeCasts.<PlateRegistrationC2cFragment>unsafeCast(this));
    }
  }
