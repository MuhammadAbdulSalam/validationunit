...
public abstract class Hilt_ValidationResultsHorizonFragment<VBinding extends ViewBinding> extends ValidationResultsBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ValidationResultsHorizonFragment_GeneratedInjector) this.generatedComponent()).injectValidationResultsHorizonFragment(UnsafeCasts.<ValidationResultsHorizonFragment>unsafeCast(this));
    }
  }
