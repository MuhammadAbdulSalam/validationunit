...
public abstract class Hilt_NoConfigC2cFragment<VBinding extends ViewBinding> extends NoConfigBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NoConfigC2cFragment_GeneratedInjector) this.generatedComponent()).injectNoConfigC2cFragment(UnsafeCasts.<NoConfigC2cFragment>unsafeCast(this));
    }
  }
