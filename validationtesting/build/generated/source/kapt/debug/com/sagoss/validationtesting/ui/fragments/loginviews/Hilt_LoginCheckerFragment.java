...
public abstract class Hilt_LoginCheckerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginCheckerFragment() {
    super();
  }

  Hilt_LoginCheckerFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginCheckerFragment_GeneratedInjector) this.generatedComponent()).injectLoginCheckerFragment(UnsafeCasts.<LoginCheckerFragment>unsafeCast(this));
    }
  }
