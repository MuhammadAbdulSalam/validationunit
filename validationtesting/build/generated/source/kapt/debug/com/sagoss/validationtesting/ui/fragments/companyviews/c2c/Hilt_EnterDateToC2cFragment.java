...
public abstract class Hilt_EnterDateToC2cFragment<VBinding extends ViewBinding> extends EnterDateToBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EnterDateToC2cFragment_GeneratedInjector) this.generatedComponent()).injectEnterDateToC2cFragment(UnsafeCasts.<EnterDateToC2cFragment>unsafeCast(this));
    }
  }
