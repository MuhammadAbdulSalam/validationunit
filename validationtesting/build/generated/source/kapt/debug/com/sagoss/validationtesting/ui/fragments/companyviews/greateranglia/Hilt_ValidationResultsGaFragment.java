...
public abstract class Hilt_ValidationResultsGaFragment<VBinding extends ViewBinding> extends ValidationResultsBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ValidationResultsGaFragment_GeneratedInjector) this.generatedComponent()).injectValidationResultsGaFragment(UnsafeCasts.<ValidationResultsGaFragment>unsafeCast(this));
    }
  }
