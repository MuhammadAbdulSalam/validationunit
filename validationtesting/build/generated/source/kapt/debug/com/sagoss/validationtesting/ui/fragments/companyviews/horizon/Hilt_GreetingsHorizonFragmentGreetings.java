...
public abstract class Hilt_GreetingsHorizonFragmentGreetings<VBinding extends ViewBinding> extends GreetingsBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GreetingsHorizonFragmentGreetings_GeneratedInjector) this.generatedComponent()).injectGreetingsHorizonFragmentGreetings(UnsafeCasts.<GreetingsHorizonFragmentGreetings>unsafeCast(this));
    }
  }
