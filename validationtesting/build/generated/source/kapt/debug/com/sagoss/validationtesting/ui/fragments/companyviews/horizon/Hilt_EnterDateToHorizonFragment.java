...
public abstract class Hilt_EnterDateToHorizonFragment<VBinding extends ViewBinding> extends EnterDateToBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EnterDateToHorizonFragment_GeneratedInjector) this.generatedComponent()).injectEnterDateToHorizonFragment(UnsafeCasts.<EnterDateToHorizonFragment>unsafeCast(this));
    }
  }
