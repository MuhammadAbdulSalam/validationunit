...
public abstract class Hilt_VoucherGaFragment<VBinding extends ViewBinding> extends VouchersListBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VoucherGaFragment_GeneratedInjector) this.generatedComponent()).injectVoucherGaFragment(UnsafeCasts.<VoucherGaFragment>unsafeCast(this));
    }
  }
