...
public abstract class Hilt_HotelGaFragment<VBinding extends ViewBinding> extends HotelBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HotelGaFragment_GeneratedInjector) this.generatedComponent()).injectHotelGaFragment(UnsafeCasts.<HotelGaFragment>unsafeCast(this));
    }
  }
