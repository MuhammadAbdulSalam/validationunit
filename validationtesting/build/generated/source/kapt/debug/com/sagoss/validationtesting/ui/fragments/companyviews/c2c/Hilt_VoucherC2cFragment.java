...
public abstract class Hilt_VoucherC2cFragment<VBinding extends ViewBinding> extends VouchersListBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VoucherC2cFragment_GeneratedInjector) this.generatedComponent()).injectVoucherC2cFragment(UnsafeCasts.<VoucherC2cFragment>unsafeCast(this));
    }
  }
