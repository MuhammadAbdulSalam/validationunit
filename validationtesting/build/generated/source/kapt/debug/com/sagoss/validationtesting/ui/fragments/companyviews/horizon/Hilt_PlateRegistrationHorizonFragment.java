...
public abstract class Hilt_PlateRegistrationHorizonFragment<VBinding extends ViewBinding> extends EnterPlateBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlateRegistrationHorizonFragment_GeneratedInjector) this.generatedComponent()).injectPlateRegistrationHorizonFragment(UnsafeCasts.<PlateRegistrationHorizonFragment>unsafeCast(this));
    }
  }
