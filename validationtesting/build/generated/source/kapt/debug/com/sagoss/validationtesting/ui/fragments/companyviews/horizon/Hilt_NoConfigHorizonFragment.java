...
public abstract class Hilt_NoConfigHorizonFragment<VBinding extends ViewBinding> extends NoConfigBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NoConfigHorizonFragment_GeneratedInjector) this.generatedComponent()).injectNoConfigHorizonFragment(UnsafeCasts.<NoConfigHorizonFragment>unsafeCast(this));
    }
  }
