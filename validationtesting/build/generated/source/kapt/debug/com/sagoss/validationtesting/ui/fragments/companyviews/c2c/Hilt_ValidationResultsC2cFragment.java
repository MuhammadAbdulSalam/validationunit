...
public abstract class Hilt_ValidationResultsC2cFragment<VBinding extends ViewBinding> extends ValidationResultsBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ValidationResultsC2cFragment_GeneratedInjector) this.generatedComponent()).injectValidationResultsC2cFragment(UnsafeCasts.<ValidationResultsC2cFragment>unsafeCast(this));
    }
  }
