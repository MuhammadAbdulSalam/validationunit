...
public abstract class Hilt_HotelHorizonFragment<VBinding extends ViewBinding> extends HotelBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HotelHorizonFragment_GeneratedInjector) this.generatedComponent()).injectHotelHorizonFragment(UnsafeCasts.<HotelHorizonFragment>unsafeCast(this));
    }
  }
