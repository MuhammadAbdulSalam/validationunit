...
public abstract class Hilt_EnterDateToGaFragment<VBinding extends ViewBinding> extends EnterDateToBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EnterDateToGaFragment_GeneratedInjector) this.generatedComponent()).injectEnterDateToGaFragment(UnsafeCasts.<EnterDateToGaFragment>unsafeCast(this));
    }
  }
