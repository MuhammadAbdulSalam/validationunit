...
public abstract class Hilt_LoginRegistrationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginRegistrationFragment() {
    super();
  }

  Hilt_LoginRegistrationFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginRegistrationFragment_GeneratedInjector) this.generatedComponent()).injectLoginRegistrationFragment(UnsafeCasts.<LoginRegistrationFragment>unsafeCast(this));
    }
  }
