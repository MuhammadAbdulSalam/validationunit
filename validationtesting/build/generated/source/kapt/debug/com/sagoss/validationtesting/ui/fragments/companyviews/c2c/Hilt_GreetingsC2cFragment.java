...
public abstract class Hilt_GreetingsC2cFragment<VBinding extends ViewBinding> extends GreetingsBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GreetingsC2cFragment_GeneratedInjector) this.generatedComponent()).injectGreetingsC2cFragment(UnsafeCasts.<GreetingsC2cFragment>unsafeCast(this));
    }
  }
