...
public abstract class Hilt_GreetingsGaFragment<VBinding extends ViewBinding> extends GreetingsBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GreetingsGaFragment_GeneratedInjector) this.generatedComponent()).injectGreetingsGaFragment(UnsafeCasts.<GreetingsGaFragment>unsafeCast(this));
    }
  }
