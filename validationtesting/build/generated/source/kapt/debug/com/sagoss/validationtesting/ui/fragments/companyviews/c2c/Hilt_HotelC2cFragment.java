...
public abstract class Hilt_HotelC2cFragment<VBinding extends ViewBinding> extends HotelBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HotelC2cFragment_GeneratedInjector) this.generatedComponent()).injectHotelC2cFragment(UnsafeCasts.<HotelC2cFragment>unsafeCast(this));
    }
  }
