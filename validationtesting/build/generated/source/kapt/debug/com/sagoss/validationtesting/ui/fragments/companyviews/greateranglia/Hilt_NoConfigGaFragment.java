...
public abstract class Hilt_NoConfigGaFragment<VBinding extends ViewBinding> extends NoConfigBaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NoConfigGaFragment_GeneratedInjector) this.generatedComponent()).injectNoConfigGaFragment(UnsafeCasts.<NoConfigGaFragment>unsafeCast(this));
    }
  }
