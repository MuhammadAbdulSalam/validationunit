...
public class EnterDateToC2cFragmentDirections private constructor() {
  private data class ActionFragmentDateToC2cToFragmentValidationComplete(
    ...
    public override fun getActionId(): Int =
        R.id.action_fragment_date_to_c2c_to_fragment_validation_complete
  ...
  public companion object {
    public fun actionFragmentDateToC2cToFragmentValidationComplete(
      voucher: Voucher,
      plateNumber: String,
      dateTo: String,
      dateFrom: String
    ): NavDirections = ActionFragmentDateToC2cToFragmentValidationComplete(voucher, plateNumber,
        dateTo, dateFrom)
  }
}
