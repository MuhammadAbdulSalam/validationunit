...
public class HotelGaFragmentDirections private constructor() {
  private data class ActionFragmentHotelGaToFragmentValidationGa(
    public val voucher: Voucher,
    public val plateNumber: String,
    public val dateTo: String,
    public val dateFrom: String
  ) : NavDirections {
    public override fun getActionId(): Int = R.id.action_fragment_hotel_ga_to_fragment_validation_ga
  ...
  public companion object {
    public fun actionFragmentHotelGaToFragmentValidationGa(
      voucher: Voucher,
      plateNumber: String,
      dateTo: String,
      dateFrom: String
    ): NavDirections = ActionFragmentHotelGaToFragmentValidationGa(voucher, plateNumber, dateTo,
        dateFrom)
  }
}
