...
public class EnterDateToHorizonFragmentDirections private constructor() {
  private data class ActionFragmentEnterDateToHorizonToFragmentHorizonValidation(
    ...
    public override fun getActionId(): Int =
        R.id.action_fragment_enter_date_to_horizon_to_fragment_horizon_validation
  ...
  public companion object {
    public fun actionFragmentEnterDateToHorizonToFragmentHorizonValidation(
      voucher: Voucher,
      plateNumber: String,
      dateTo: String,
      dateFrom: String
    ): NavDirections = ActionFragmentEnterDateToHorizonToFragmentHorizonValidation(voucher,
