...
public data class HotelHorizonFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HotelHorizonFragmentArgs {
      bundle.setClassLoader(HotelHorizonFragmentArgs::class.java.classLoader)
      ...
      return HotelHorizonFragmentArgs(__voucher, __plateNumber)
    }
  }
}
