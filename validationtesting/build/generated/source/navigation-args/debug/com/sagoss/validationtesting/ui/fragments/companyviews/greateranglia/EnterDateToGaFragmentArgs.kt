...
public data class EnterDateToGaFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EnterDateToGaFragmentArgs {
      bundle.setClassLoader(EnterDateToGaFragmentArgs::class.java.classLoader)
      ...
      return EnterDateToGaFragmentArgs(__voucher, __plateNumber)
    }
  }
}
