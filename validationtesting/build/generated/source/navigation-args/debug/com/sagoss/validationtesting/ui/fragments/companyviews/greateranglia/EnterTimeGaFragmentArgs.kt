...
public data class EnterTimeGaFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EnterTimeGaFragmentArgs {
      bundle.setClassLoader(EnterTimeGaFragmentArgs::class.java.classLoader)
      ...
      return EnterTimeGaFragmentArgs(__voucher, __plateNumber)
    }
  }
}
