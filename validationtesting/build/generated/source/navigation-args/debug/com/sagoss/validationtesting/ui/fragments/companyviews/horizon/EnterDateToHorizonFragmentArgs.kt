...
public data class EnterDateToHorizonFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EnterDateToHorizonFragmentArgs {
      bundle.setClassLoader(EnterDateToHorizonFragmentArgs::class.java.classLoader)
      ...
      return EnterDateToHorizonFragmentArgs(__voucher, __plateNumber)
    }
  }
}
